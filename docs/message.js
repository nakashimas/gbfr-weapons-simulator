const MESSAGE_TEXT = {
  "ja": {
    ...
    "conditions": {
      ...
      "isPlayerBreak": "プレイヤーがブレイク状態",
      "isPlayerOverdrive": "プレイヤーがオーバードライブ状態",
      "isPlayerSandtomb": "プレイヤーが砂だるま状態",
      "isPlayerDizzy": "プレイヤーが気絶状態",
      "isPlayerSlow": "プレイヤーがスロウ状態",
      "isPlayerBurn": "プレイヤーが灼熱状態",
      "isPlayerBlight": "プレイヤーが災禍状態",
      "isPlayerParalysis": "プレイヤーが麻痺状態",
      "isPlayerGlaciate": "プレイヤーが氷結状態",
      "isPlayerPoison": "プレイヤーが毒状態",
      "isPlayerHeldUnder": "プレイヤーが水牢状態",
      "isPlayerAttackDown": "プレイヤーが攻撃DOWN状態",
      "isPlayerDeffenceDown": "プレイヤーが防御DOWN状態",
      "isPlayerSbaSealed": "プレイヤーが奥義封印状態",
      "isPlayerSkillSealed": "プレイヤーがアビリティ封印状態",
    },
    "weapons": {
      "amenoHabakiri": "天羽々斬",
      "balmung": "バルムンク",
